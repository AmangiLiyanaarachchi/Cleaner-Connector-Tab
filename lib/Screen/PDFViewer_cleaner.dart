...
class PDFViewerFromAsset_cleaner extends StatefulWidget {
  PDFViewerFromAsset_cleaner({Key? key, required this.pdfAssetPath, required this.manualId})
      : super(key: key);
...
class _PDFViewerFromAssetState extends State<PDFViewerFromAsset_cleaner> {
