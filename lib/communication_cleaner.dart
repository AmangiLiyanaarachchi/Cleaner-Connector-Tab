...
class Communication_Cleaner extends StatefulWidget {
  Communication_Cleaner({required this.title});
  String title;
  @override
  _Communication_CleanerState createState() => _Communication_CleanerState();
}

class _Communication_CleanerState extends State<Communication_Cleaner> {
  ...
  String _selectedOption = 'Select Name';
